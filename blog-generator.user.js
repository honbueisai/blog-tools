...
(function () {
  ...
  const TOOL_ID         = 'eisai-tool-v0-56-17';
  const BTN_ID          = 'eisai-btn-v0-56-17';
  const STORAGE_KEY     = 'eisai_blog_info_v05617';
  const CURRENT_VERSION = '0.56.17';
  ...
  console.log('🚀 英才ブログ生成ツール v0.56.17 起動');
  ...
  article_structure:
    ...
    - "【本文】1〜2つのセクションで、現状・背景・原因・サポート方法を【theme】【memo】に合わせて構成（見出しには<h2>または<h3>を使う）。教室の強みや特徴を伝える際にも『英才個別学院 __KOSHA__』のように校舎名を含めること"
