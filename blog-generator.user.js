...
(function () {
  ...
  const TOOL_ID         = 'eisai-tool-v0-56-56';
  const BTN_ID          = 'eisai-btn-v0-56-56';
  const STORAGE_KEY     = 'eisai_blog_info_v05656';
  const CLASSROOM_STORAGE_KEY = 'eisai_classroom_settings_persistent';
  const CURRENT_VERSION = '0.56.56';
  ...
  console.log('🚀 英才ブログ生成ツール v0.56.56 起動');
