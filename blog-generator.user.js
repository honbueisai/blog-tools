...
(function () {
  ...
  const TOOL_ID         = 'eisai-tool-v0-56-20';
  const BTN_ID          = 'eisai-btn-v0-56-20';
  const STORAGE_KEY     = 'eisai_blog_info_v05620';
  const CURRENT_VERSION = '0.56.20';
  ...
  console.log('🚀 英才ブログ生成ツール v0.56.20 起動');
