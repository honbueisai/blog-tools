...
- CTAは本文HTMLの最後に CTA_DATA ブロックとして出力してください。CTA_DATAはツール側で読み取り、整形済みCTAへ変換します。
...
- JSON形式で出力しないでください。
- コードブロックで囲まないでください。
- Markdown見出しや箇条書き記号だけで出力しないでください。
- HTMLタグなしのプレーンテキストで出力しないでください。
- CTA_DATAだけ、相談ポイントだけ、体験ポイントだけの出力は禁止です。
