...
(function () {
  ...
  const TOOL_ID         = 'eisai-tool-v0-56-24';
  const BTN_ID          = 'eisai-btn-v0-56-24';
  const STORAGE_KEY     = 'eisai_blog_info_v05624';
  const CURRENT_VERSION = '0.56.24';
  ...
  console.log('🚀 英才ブログ生成ツール v0.56.24 起動');
  ...
  article_structure:
    ...
    - "【本文】1〜3つのセクションで、現状・背景・原因・具体的なサポート方法を【theme】【memo】に合わせて深掘りして構成（見出しには<h2>または<h3>を使う）。リストでポイントをまとめる場合は、必ずその後に各項目について見出しと段落で詳細に深掘りすること。リストを使うかどうかは、その記事のテーマに最も効果的な訴求になるかを判断して選択すること。教室の強みや特徴を伝える際にも『英才個別学院 __KOSHA__』のように校舎名を含めること"
