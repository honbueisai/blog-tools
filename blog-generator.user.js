...
(function () {
  ...
  const TOOL_ID         = 'eisai-tool-v0-56-27';
  const BTN_ID          = 'eisai-btn-v0-56-27';
  const STORAGE_KEY     = 'eisai_blog_info_v05627';
  const CURRENT_VERSION = '0.56.27';
  ...
  console.log('🚀 英才ブログ生成ツール v0.56.27 起動');
