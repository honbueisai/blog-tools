...
(function () {
  ...
  const TOOL_ID = 'eisai-chatgpt-tool-v0-1-19';
  const BTN_ID = 'eisai-chatgpt-btn-v0-1-19';
  const STORAGE_KEY = 'eisai_chatgpt_blog_info_v0119';
  ...
  const TEXT_IMPACT_OPTIONS = {
    ...
    '強め': 'Recommended. Use modern large bold flat text, strong contrast, clean outline or subtle shadow, numeric badge when available, and high thumbnail readability.',
    '最大インパクト': 'Maximum modern impact. Use one huge hero number or phrase, bold flat typography, clean sticker/badge shapes, high contrast, and dramatic crop. Avoid dated glossy 3D bevels and heavy black drop shadows.'
  };
...
5. Text Design Direction: choose typography that fits the selected thumbnail objective and visual expression, but the main headline must always be thumbnail-strong: modern thick Japanese gothic/sans-serif lettering, high contrast, clean outline or subtle shadow, readable at small size. Prefer bold flat poster typography, clean badges, editorial labels, speech bubbles, or infographic typography. Avoid dated glossy 3D lettering, heavy black drop shadows, and huge generic blue lower-third banners.
...
- メインキャッチには細い明朝体、上品な筆文字、薄い影だけの文字を使わないでください。太いゴシック体、白フチ、色面パネル、ステッカー型バッジ、太い縁取り、強いコントラストを使ってください。
...
- 禁止: 光沢の強い赤オレンジ3D文字、極太の黒い影、巨大な青い下帯、白フチを何重にも重ねた文字、爆発エフェクト、過剰な斜め文字、同じ数字の重複表示。
...
- 大きな3D文字だけで画面を埋める構図を使わないでください。とくに赤オレンジの光沢3D文字と重い黒影は避けてください
...
- 【禁止】古い広告風の赤オレンジ3D文字、重い黒影、巨大な青い下帯を使わないこと
