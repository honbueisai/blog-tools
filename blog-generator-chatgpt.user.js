...
■ サムネイル文字の強さ（最重要）
- 画像を320px幅で表示しても、メインキャッチが一瞬で読めるサイズにしてください。
- メインキャッチは画面内で最も大きい要素にしてください。目安として横幅の35〜55%を占める大きさです。
- 文字要素は最大3つまでにしてください。1. メインキャッチ、2. サブキャッチ、3. 小さな補助ラベルまたは数字バッジ。
- メインキャッチには細い明朝体、上品な筆文字、薄い影だけの文字を使わないでください。太いゴシック体、白フチ、黒影、色面リボン、太い縁取り、強いコントラストを使ってください。
- 実写背景の上に文字を置く場合は、必ず白帯・濃色帯・半透明パネル・縁取り・ドロップシャドウのいずれかで背景から分離してください。
- インパクトスタイルでは、数字やキーワードを斜め配置・立体感・太い縁取り・強い影で見せてください。ただし読みにくくなるほど装飾しないでください。
