...
(function () {
  ...
  const TOOL_ID = 'eisai-chatgpt-tool-v0-1-34';
  const BTN_ID = 'eisai-chatgpt-btn-v0-1-34';
  const STORAGE_KEY = 'eisai_chatgpt_blog_info_v0134';
  const CLASSROOM_STORAGE_KEY = 'eisai_classroom_settings_persistent';
  const CURRENT_VERSION = '0.1.34';
