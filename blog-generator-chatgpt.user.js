...
- まず内部で、今回いちばん狙う反応を1つ選んでください。この選択は出力しないでください。
  ...
  - 安心: 「相談してもいいのかも」
  - 希望: 「うちの子も少し変われるかも」
- メインキャッチは弱くしないでください。ブログタイトルと同じくらい強く、記事の一番の"見せ場"（結果・変化・できるようになったこと）が一瞬で伝わる言葉にしてください。
- 【最重要】記事に明確な結果・数字・変化がある場合（例: 満点が増えた／点数が上がった／できるようになった／自分から動いた）は、必ずそれをメインキャッチの主役にしてください。感想だけの弱い一言（例:「英語ってちょっと楽しいかも」）で終わらせないでください。
- 記事の「一番強い事実」を、短く言い切る形にしてください。例:「満点が増えた英単語術」「発音を変えたら満点続出」「1日5単語で満点へ」「48→76点の途中式」「自分から解き直した中2数学」。
- 感想・気持ちを使う場合も、必ず結果や変化とセットにして強さを出してください。単独の「〜かも」「〜楽しい」だけは弱いので避けてください。
- 「続きを知りたくなる余白」は大切ですが、弱く・曖昧にする言い訳にはしないでください。結果を主役にしつつ、その理由やきっかけを"少しだけ"隠すのが良い余白です。
- ただし釣りっぽい煽りや嘘は使わないでください。記事本文にある悩み・場面・変化・結果から自然に作ってください。
...
■ キャッチの考え方
- おまかせモードの場合は、ブログ記事からメインキャッチとサブキャッチを自分で考えてください。ブログタイトルをそのまま使うだけは禁止ですが、タイトルにある強い要素（結果・数字・変化・教科・学年）は積極的に活かしてください。
- メインキャッチは、ブログタイトルと同等以上に強くしてください。記事の一番の成果・変化（例: 満点が増えた／点数が上がった／自分から動いた）を主役にし、それが一目で伝わる言葉にします。
- 感情や気持ちだけの弱いキャッチ（例:「英語ってちょっと楽しいかも」）にしないでください。感情を使う場合も、必ず結果・変化とセットで強く言い切ってください。
- メインキャッチは「全部わかる言葉」より「気になって続きを見たくなる言葉」を優先しますが、"弱く曖昧にする"のではなく"結果を見せてその理由を少しだけ隠す"形にしてください。
